  ...
  return (
    <>
      <motion.div
        ...
        className='card-hover capitalize'>
        <div className='card-hover__content'>
          <motion.h3
            ...
            Explore <span>{courseName ? courseName : 'Add Course Name'}</span>{' '}
            right now!
          </motion.h3>
          <p className='card-hover__text'>
            {para ? para : '##### Please Add Paragraph'}
          </p>
          <Link
            className='card-hover__link'
            href={redirectTo ? redirectTo : '/404'}>
        ...
        <Image
          src='https://cdn.pixabay.com/photo/2020/07/10/18/53/elephant-5391723_1280.jpg'
          alt=''
          width={1200}
          height={800}
        />
